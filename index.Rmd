...
Access to mobility is key to full participation in urban life. For many people, that means walking to a transit stop. This map assigns accessibility scores across Boston, using a distance-function of walking time to the closest transit stop. 
